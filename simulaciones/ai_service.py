...
def generar_simulacion_y_feedback(
    *,
    ...
    system_prompt = (
        ...
        '\n'
        'FEEDBACK - ESTRUCTURA COMPLETAMENTE DIFERENTE:\n'
        '  PHISHING (es_phishing=true): Describe SEÑALES DE ATAQUE\n'
        '    - Qué hace que ESTE EMAIL sea phishing\n'
        '    - Características sospechosas presentes\n'
        '    - Ejemplo: "dominio falso que simula oficial", "urgencia artificial", "solicita credenciales"\n'
        '\n'
        '  LEGITIMO (es_phishing=false): Describe POR QUÉ ES SEGURO\n'
        '    - NUNCA mencionar "falso", "phishing", "ataque", "urgencia", "amenaza", "sospechoso"\n'
        '    - SOLO describe características de confianza: dominio, profesionalismo, propósito informativo\n'
        '    - Ejemplos:\n'
        '      ✓ "Remitente oficial del banco usando dominio verificado"\n'
        '      ✓ "Mensaje informativo sin solicitudes de datos o acciones urgentes"\n'
        '      ✓ "Comunicación profesional de entity oficial"\n'
        '      ✗ "No tiene dominio falso" (PROHIBIDO - menciona phishing)\n'
        '      ✗ "No es phishing porque..." (PROHIBIDO - menciona phishing)\n'
        '\n'
